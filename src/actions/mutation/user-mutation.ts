...
export const useUpdateUserProfile = () => {
  const useUpdateUserProfile = useMutation(api.users.updateUserProfile);
  return useMutationHook(useUpdateUserProfile);
};

export const useUpdateUserPrivacy = () => {
  const useUpdateUserPrivacy = useMutation(api.users.updateUserPrivacy);
